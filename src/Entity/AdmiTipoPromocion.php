...
use App\Repository\AdmiTipoPromocionRepository;
 ...
 * @ORM\Entity(repositoryClass=AdmiTipoPromocionRepository::class)
 */
class AdmiTipoPromocion
{
    /**
     * @ORM\Column(name="ID_TIPO_PROMOCION", type="integer")
     * @ORM\Id()
     * @ORM\GeneratedValue
