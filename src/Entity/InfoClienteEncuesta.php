 ...
 * @ORM\Entity(repositoryClass="App\Repository\InfoClienteEncuestaRepository")
 */
class InfoClienteEncuesta
{
    ...
    */
     ...
     * Set ENCUESTAID
     *
     * @param \App\Entity\InfoEncuesta $ENCUESTAID
     *
     * @return InfoClienteEncuesta
     */
    public function setENCUESTAID(\App\Entity\InfoEncuesta $ENCUESTAID = null)
    {
     ...
     * Set CONTENIDOID
     *
     * @param \App\Entity\InfoContenidoSubido $CONTENIDOID
     *
     * @return InfoClienteEncuesta
     */
    public function setCONTENIDOID(\App\Entity\InfoContenidoSubido $CONTENIDOID = null)
    {
     ...
     * Get CONTENIDOID
     *
     * @return \App\Entity\InfoContenidoSubido
     */
